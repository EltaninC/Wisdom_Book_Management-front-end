<template>
    ...
    >
      <el-form :model="form">
        <el-form-item label="book_id" :label-width="formLabelWidth">
          <el-input v-model="form.book_id" autocomplete="off" />
        </el-form-item>
        <el-form-item label="user_id" :label-width="formLabelWidth">
          <el-input v-model="form.user_id" autocomplete="off" readonly="true"/>
        </el-form-item>
        <el-form-item label="end_date" :label-width="formLabelWidth">
          <el-input v-model="form.end_date" autocomplete="off" />
        </el-form-item>
      </el-form>
      <template #footer>
