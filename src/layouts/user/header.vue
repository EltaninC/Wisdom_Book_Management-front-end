<template>
	...
	<el-breadcrumb separator="/">
 	...
 	<Recharge :recharge-form-visible="rechargeFormVisible" @close="close"></Recharge>
		
	<div class="right">
		<el-button type="primary" round @click="rechargeFormVisible=true">充值</el-button>
		<el-icon>
			<Message />
		</el-icon>
...
<script setup lang="ts">
	...
	const rechargeFormVisible = ref(false)
